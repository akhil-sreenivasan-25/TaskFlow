...
SECRET_KEY = 'django-insecure-aoo_+z^lbp$mu5q^vfd$jkg+tm!8kap^bn^@62pk#w4w2=fvoq'
...
# TIME_ZONE = 'UTC' #for international time zone
TIME_ZONE = 'Asia/Kolkata' #for india time zone
USE_TZ = False
